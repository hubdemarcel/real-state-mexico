<?php
$pageTitle = 'Casas en Renta en México - Tierras.mx';
include 'header.php';
?>
...
<main class="container">
    <section class="section">
        <div class="section-header">
            <h1 class="section-title">Casas en Renta</h1>
            <p class="section-subtitle">Encuentra la casa perfecta para rentar en México</p>
        </div>
        ...
        <div class="results-header">
            <div>
                <h2 class="results-title">Propiedades en Renta Disponibles</h2>
                <div class="results-count">Explorando propiedades en renta en México</div>
            </div>
        ...
        <div class="properties-grid" id="propertyGrid">
            ...
            <div class="loading-state">
                ...
                <p>Cargando propiedades en renta...</p>
            </div>
        </div>
